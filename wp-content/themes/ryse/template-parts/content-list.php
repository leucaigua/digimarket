...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'row style-six' ); ?>>
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
		<div class="post-thumbnail matchHeight">
			<img src="<?php echo esc_url( get_parent_theme_file_uri( '/assets/images/no-image/No-Image-Found-400x264.png' ) ); ?>" alt="<?php echo esc_attr__( 'No Image Found', 'ryse' ); ?>" width="400" height="264">
	...
	<?php } ?>
		<div class="entry-main matchHeight">
			...
			<div class="post-meta">
				<span class="date"><?php echo esc_html__('Published On', 'ryse'); ?> <?php the_date(); ?></span>
				<?php if ( true == ryse_global_var( 'display_categries', '', false ) ) : ?>
					<span class="category-list">
						<?php echo esc_html__('In', 'ryse'); ?>
						<?php
			...
			<!-- <div class="more">
				<a class="btn" href="<?php esc_url( get_permalink() ); ?>"><span><?php echo esc_html__('Continue Reading', 'ryse'); ?></span><span class="btn-arrow"><i class="fa fa-angle-right"></i></span></a>
			</div> .more -->
		</div><!-- .entry-main -->
	</div>
</article><!-- #post-## -->
