			...
			<div class="row case-studies-single-pagination">
				<div class="col-xl-4 col-md-4 col-sm-12 col-xs-12">
				  ...
				  <?php
					...
					if ( $prev_post ) {
					 ...
					 <span class="case-studies-single-previous-post-title"><?php echo esc_html__( 'Previous Post', 'ryse' ); ?> </span>
				...
				<div class="col-xl-4 col-md-4 col-sm-12 col-xs-12">
				  ...
				  <a href="<?php echo get_permalink( $next_post->ID ); ?>">
					 ...
					 <span class="case-studies-single-previous-post-title"><?php echo esc_html__( 'Next Post', 'ryse' ); ?></span>
