...
function ryse_register_required_plugins() {
	$plugins = array(
		...
		array(
			...
			'slug'     => 'revslider',
			'source'   => 'https://ryse.radiantthemes.com/plugins/revslider.zip',
			'required' => true,
			//'version'  => '6.1.5',
		),
		// RT Custom Post Type.
		array(
			'name'     => esc_html__( 'RadiantThemes Custom Post Type', 'ryse' ),
			'slug'     => 'radiantthemes-custom-post-type',
			'source'   => 'https://ryse.radiantthemes.com/plugins/radiantthemes-custom-post-type-new.zip',
			'required' => true,
			//'version'  => '1.0.0',
		),
		// RadiantThemes Addons.
		array(
			'name'     => esc_html__( 'Radiantthemes Addons', 'ryse' ),
			'slug'     => 'radiantthemes-addons',
			'source'   => 'https://ryse.radiantthemes.com/plugins/radiantthemes-addons.zip',
			'required' => true,
			//'version'  => '1.0.0',
		),
		// Unyson.
