		...
		<div class="row">
			...
			<?php } else { ?>
				<?php if ( 'leftsidebar' === ryse_global_var( 'blog-layout', '', false ) ) { ?>
					<?php if ( 'three-grid' === ryse_global_var( 'blog-layout-sidebar-width', '', false ) ) { ?>
						<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 pull-right">
					<?php } elseif ( 'four-grid' === ryse_global_var( 'blog-layout-sidebar-width', '', false ) ) { ?>
						<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12 pull-right">
					<?php } elseif ( 'five-grid' === ryse_global_var( 'blog-layout-sidebar-width', '', false ) ) { ?>
						...
						<div class="row">
							...
							if ( have_posts() ) :
								...
								while ( have_posts() ) :
									 ...
									 */
									if ( 'leftsidebar' === ryse_global_var( 'blog-layout', '', false ) ) {
										echo '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">';
									} elseif ( 'rightsidebar' === ryse_global_var( 'blog-layout', '', false ) ) {
										echo '<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">';
									} else {
