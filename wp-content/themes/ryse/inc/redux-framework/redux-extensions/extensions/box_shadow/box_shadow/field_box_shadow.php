	...
	class ReduxFramework_box_shadow extends ReduxFramework_extension_box_shadow {
		...
		private function getRGBA( $color, $opacity = false ) {
			...
			if ( $opacity ) {
				...
				$output = 'rgba(' . implode( ',', $rgb ) . ',' . str_replace('px', '', $opacity) . ')';
			} else {
		...
		public function render() {
			...
			echo '<div id="box-shadow" class="redux-shadow-container" data-id="' . esc_attr( $this->field['id'] ) . '">';
			...
			if ( $this->field['horizontal'] === true ) {
				...
				echo '<label>' . esc_html__( 'Offset X', 'ryse' ) . '</label>';
				echo '<span class="add-on"><i class="el el-resize-horizontal icon-large"></i></span>';
				echo '<input type="text" class="redux-shadow-input redux-shadow-horizontal mini ' . esc_attr( $this->field['class'] ) . '" placeholder="' . esc_attr__( 'X', 'ryse' ) . '" rel="' . esc_attr( $this->field['id'] ) . '-horizontal" value="' . filter_var( $this->value['horizontal'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
				echo '<input class="redux-shadow-value shadow-offsetx-value" data-id="' . esc_attr( $this->field['id'] ) . '" type="hidden" id="' . esc_attr( $this->field['id'] ) . '-horizontal" name="' . esc_attr( $this->field['name'] ) . esc_attr( $this->field['name_suffix'] ) . '[horizontal]' . '" value="' . esc_attr( $this->value['horizontal'] ) . '"></div>';
			}
			...
			if ( $this->field['vertical'] === true ) {
				...
				echo '<div class="field-shadow-input input-prepend">';
				echo '<label>' . esc_html__( 'Offset Y', 'ryse' ) . '</label>';
				echo '<span class="add-on"><i class="el el-resize-vertical icon-large"></i></span>';
				echo '<input type="text" class="redux-shadow-input redux-shadow-vertical mini ' . esc_attr( $this->field['class'] ) . '" placeholder="' . esc_attr__( 'Y', 'ryse' ) . '" rel="' . esc_attr( $this->field['id'] ) . '-vertical" value="' . filter_var( $this->value['vertical'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
				echo '<input class="redux-shadow-value shadow-offsety-value" data-id="' . esc_attr( $this->field['id'] ) . '" type="hidden" id="' . esc_attr( $this->field['id'] ) . '-vertical" name="' . esc_attr( $this->field['name'] ) . esc_attr( $this->field['name_suffix'] ) . '[vertical]' . '" value="' . esc_attr( $this->value['vertical'] ) . '"></div>';
			}
			...
			if ( $this->field['blur'] === true ) {
				...
				echo '<div class="field-shadow-input input-prepend">';
				echo '<label>' . esc_html__( 'Blur Radius', 'ryse' ) . '</label>';
				echo '<span class="add-on"><i class="el el-adjust icon-large"></i></span>';
				echo '<input type="text" class="redux-shadow-input redux-shadow-blur mini ' . esc_attr( $this->field['class'] ) . '" placeholder="' . esc_attr__( 'Blur', 'ryse' ) . '" rel="' . esc_attr( $this->field['id'] ) . '-blur" value="' . filter_var( esc_attr( $this->value['blur'] ), FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
				echo '<input class="redux-shadow-value shadow-blur-value" data-id="' . esc_attr( $this->field['id'] ) . '" type="hidden" id="' . esc_attr( $this->field['id'] ) . '-blur" name="' . esc_attr( $this->field['name'] ) . esc_attr( $this->field['name_suffix'] ) . '[blur]' . '" value="' . esc_attr( $this->value['blur'] ) . '"></div>';
			}
			...
			if ( $this->field['spread'] === true ) {
				...
				echo '<div class="field-shadow-input input-prepend">';
				echo '<label>' . esc_html__( 'Spread Radius', 'ryse' ) . '</label>';
				echo '<span class="add-on"><i class="el el-idea icon-large"></i></span>';
				echo '<input type="text" class="redux-shadow-input redux-shadow-spread mini ' . esc_attr( $this->field['class'] ) . '" placeholder="' . esc_attr__( 'Spread', 'ryse' ) . '" rel="' . esc_attr( $this->field['id'] ) . '-spread" value="' . filter_var( $this->value['spread'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
				echo '<input class="redux-shadow-value shadow-spread-value" data-id="' . esc_attr( $this->field['id'] ) . '" type="hidden" id="' . esc_attr( $this->field['id'] ) . '-spread" name="' . esc_attr( $this->field['name'] ) . esc_attr( $this->field['name_suffix'] ) . '[spread]' . '" value="' . esc_attr( $this->value['spread'] ) . '"></div>';
			}
			...
			if ( $this->field['opacity'] === true ) {
				...
				echo '<div class="field-shadow-input input-prepend">';
				echo '<label>' . esc_html__( 'Opacity .1 - 1', 'ryse' ) . '</label>';
				echo '<span class="add-on"><i class="el el-idea icon-large"></i></span>';
				echo '<input type="text" class="redux-shadow-input redux-shadow-opacity mini ' . esc_attr( $this->field['class'] ) . '" placeholder="' . esc_attr__( 'Opacity', 'ryse' ) . '" rel="' . esc_attr( $this->field['id'] ) . '-opacity" value="' . filter_var( $this->value['opacity'], FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION ) . '">';
				echo '<input class="redux-shadow-value shadow-opacity-value" data-id="' . esc_attr( $this->field['id'] ) . '" type="hidden" id="' . esc_attr( $this->field['id'] ) . '-opacity" name="' . esc_attr( $this->field['name'] ) . esc_attr( $this->field['name_suffix'] ) . '[opacity]' . '" value="' . esc_attr( $this->value['opacity'] ) . '"></div>';
			}
			...
			if ( isset( $this->field['units'] ) && $this->field['units'] !== false ) {
				echo '<div class="shadow-units" original-title="' . esc_attr__( 'Units', 'ryse' ) . '">';
				echo '<label>' . esc_html__( 'Units', 'ryse' ) . '</label>';
				echo '<select data-id="' . esc_attr( $this->field['id'] ) . '" data-placeholder="' . esc_attr__( 'Units', 'ryse' ) . '" class="redux-shadow redux-shadow-units select ' . esc_attr( $this->field['class'] ) . '" original-title="' . esc_attr__( 'Units', 'ryse' ) . '" name="' . esc_attr( $this->field['name'] ) . esc_attr( $this->field['name_suffix'] ) . '[units]' . '">';
			...
			if ( $this->field['shadow-color'] === true ) {
				...
				echo '<div class="shadow-color" original-title="' . esc_attr__( 'Shadow Color', 'ryse' ) . '">';

				echo '<label>' . esc_html__( 'Shadow Color', 'ryse' ) . '</label>';

				echo '<input data-id="' . esc_attr( $this->field['id'] ) . '" name="' . esc_attr( $this->field['name'] ) . esc_attr( $this->field['name_suffix'] ) . '[shadow-color]" id="' . esc_attr( $this->field['id'] ) . '-color" class="redux-color redux-original-color redux-background-input redux-color-init ' . esc_attr( $this->field['class'] ) . '"  type="text" value="' . esc_attr( $this->value['shadow-color'] ) . '"  data-default-color="' . ( isset( $this->field['default']['shadow-color'] ) ? esc_attr( $this->field['default']['shadow-color'] ) : '' ) . '" />';

				echo '<input class="redux-shadow-value shadow-color-value" data-id="' . esc_attr( $this->field['id'] ) . '" type="hidden" id="' . esc_attr( $this->field['id'] ) . '-color" name="' . esc_attr( $this->field['name'] ) . esc_attr( $this->field['name_suffix'] ) . '[shadow-color]' . '" value="' . esc_attr( $this->value['shadow-color'] ) . '">';
			...
			if ( $this->field['shadow-type'] === true ) {
				...
				echo '<div class="shadow-type" original-title="' . esc_attr__( 'Shadow Type', 'ryse' ) . '">';
				echo '<label>' . esc_html__( 'Shadow Type', 'ryse' ) . '</label>';
				echo '<select id="' . esc_attr( $this->field['id'] ) . '-shadow-type-select" data-placeholder="' . esc_attr__( 'Shadow Type', 'ryse' ) . '" name="' . esc_attr( $this->field['name'] ) . esc_attr( $this->field['name_suffix'] ) . '[shadow-type]" class="redux-select-item redux-background-input redux-shadow-type ' . esc_attr( $this->field['class'] ) . '">';
				echo '<option></option>';

				foreach ( $array as $k => $v ) {
					echo '<option value="' . esc_attr( $k ) . '"' . esc_attr( selected( $this->value['shadow-type'], $k, false ) ) . '>' . esc_attr( $v ) . '</option>';
				}
				echo '</select></div>';
			}
			...
			echo '<input class="redux-rgba-value shadow-rgba-value" data-id="' . esc_attr( $this->field['id'] ) . '" type="hidden" id="' . esc_attr( $this->field['id'] ) . '-rgba" name="' . esc_attr( $this->field['name'] ) . esc_attr( $this->field['name_suffix'] ) . '[rgba]' . '" value="' . esc_attr( $this->value['rgba'] ) . '"></div>';
			...
			if ( $this->field['preview'] === true ) {
				...
				echo '<div class="clearfix"></div><div class="shadow-previewer" original-title="' . esc_attr__( 'Shadow Preview', 'ryse' ) . '">';
