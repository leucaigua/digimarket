					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<header class="woocommerce-products-header">
							...
							<?php
								 ...
								 *
								 * @hooked woocommerce_taryseomy_archive_description - 10
	...
	<?php } else { ?>
		...
		<div class="wraper_shop_main">
			<div class="container">
				<!-- row -->
				<div class="row">
					<?php if ( 'shop-nosidebar' === ryse_global_var( 'shop-sidebar', '', false ) ) { ?>
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<?php } else { ?>
						<?php if ( 'shop-leftsidebar' === ryse_global_var( 'shop-sidebar', '', false ) ) { ?>
							<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 pull-right">
						<?php } elseif ( 'shop-rightsidebar' === ryse_global_var( 'shop-sidebar', '', false ) ) { ?>
