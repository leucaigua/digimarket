...
$output  = '<div  class="rt-case-study-box-filter element-one filter-style-' . esc_attr( $settings['case_study_filter_style'] ) . ' text-' . esc_attr( $settings['case_study_filter_alignment'] ) . ' ' . esc_attr( $hidden_filter ) . '">';
...
$output .= '</div>';
$output .= '<div class="rt-case-study-box element-one row isotope ' . esc_attr( $enable_zoom ) . '" data-case-study-box-align="' . esc_attr( $settings['case_study_box_alignment'] ) . '" style="margin-left:-' . esc_attr( $spacing_value ) . 'px; margin-right:-' . esc_attr( $spacing_value ) . 'px;">';
