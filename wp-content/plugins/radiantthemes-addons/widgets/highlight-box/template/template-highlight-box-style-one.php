...
$output .= '<h4>' . esc_attr( $settings['highlight_box_title'] ) . '</h4>';
$output .= '<p>' . esc_attr( $settings['highlight_box_content'] ) . '</p>';
...
$output .= '<div class="table">';
$output .= '<div class="table-cell">';
$output .=  wp_get_attachment_image( $settings['highlight_box_image']['id'], 'full' );
$output .= '</div>';
$output .= '</div>';
$output .= '</div>';
$output .= '</div>';
