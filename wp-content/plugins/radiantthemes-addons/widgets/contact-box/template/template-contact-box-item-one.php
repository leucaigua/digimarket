...
if ( $settings['contact_box_email'] ) {
	$output .= '<li class="email"><i class="fa fa-envelope"></i><strong>' . esc_html__( 'Email', 'radiantthemes-addons' ) . '</strong> ' . $settings['contact_box_email'] . '</li>';
}
if ( $settings['contact_box_phone'] ) {
	$output .= '<li class="phone"><i class="fa fa-phone"></i><strong>' . esc_html__( 'Phone', 'radiantthemes-addons' ) . '</strong> ' . $settings['contact_box_phone'] . '</li>';
}
